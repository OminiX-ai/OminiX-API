...
impl QwenTtsCtx {
    ...
    // v1.2 (2026-04-20): The fine-grained primitive methods —
    // reset_cache, text_embed, codec_embed, codec_head, generation_embed,
    // forward, predict_codes, decode_audio, extract_speaker — were removed
    // after upstream's QwenTTS::generate() unification dropped the TalkerLLM
    // friend accessors that backed them. No in-tree consumer existed; the
    // Ascend FFI path drives generation exclusively through `synthesize()`.
